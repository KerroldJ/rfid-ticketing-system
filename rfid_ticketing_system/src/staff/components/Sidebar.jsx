          ...
          <div className="w-full flex justify-center">
              <div className="space-y-4 text-center m-6 text-2xl">
                  <ul className="flex flex-col items-center">
                      <li>
                          <Link to="/staff" className="m-5 flex items-center space-x-2 py-2 px-4 rounded-lg text-white hover:bg-gray-700 hover:text-gray-300 transition-all">
                              <span className="material-icons"></span>
                              <span>Dashboard</span>
                          </Link>
                      </li>
                      <li>
                          <Link to="scan-card" className="m-5 flex items-center space-x-2 py-2 px-4 rounded-lg text-white hover:bg-gray-700 hover:text-gray-300 transition-all">
                              <span className="material-icons"></span>
